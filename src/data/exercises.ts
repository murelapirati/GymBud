...
export const PREDEFINED_EXERCISES: MappedExercise[] = [
  ...
  { id: 'ex_6', name: 'Chest Flyes (Dumbbell/Cable)', type: 'gym', primaryMuscles: ['chest'], secondaryMuscles: [], difficultyMultiplier: 0.4 },
  ...
  { id: 'ex_11', name: 'Chin-ups', type: 'calisthenics', primaryMuscles: ['lats', 'biceps'], secondaryMuscles: ['upper_back'], difficultyMultiplier: 0.95 },
  ...
  { id: 'ex_17', name: 'Back Extension', type: 'gym', primaryMuscles: ['lower_back'], secondaryMuscles: ['glutes', 'hamstrings'], difficultyMultiplier: 0.4 },
  ...
  { id: 'ex_20', name: 'Lateral Raises', type: 'gym', primaryMuscles: ['side_delts'], secondaryMuscles: [], difficultyMultiplier: 0.3 },
  { id: 'ex_21', name: 'Front Raises', type: 'gym', primaryMuscles: ['front_delts'], secondaryMuscles: [], difficultyMultiplier: 0.3 },
  { id: 'ex_22', name: 'Face Pulls', type: 'gym', primaryMuscles: ['rear_delts'], secondaryMuscles: ['upper_back'], difficultyMultiplier: 0.4 },
  { id: 'ex_23', name: 'Reverse Pec Deck', type: 'gym', primaryMuscles: ['rear_delts'], secondaryMuscles: ['upper_back'], difficultyMultiplier: 0.4 },
  ...
  { id: 'ex_28', name: 'Preacher Curl', type: 'gym', primaryMuscles: ['biceps'], secondaryMuscles: [], difficultyMultiplier: 0.4 },
  { id: 'ex_29', name: 'Tricep Pushdown', type: 'gym', primaryMuscles: ['triceps'], secondaryMuscles: [], difficultyMultiplier: 0.4 },
  { id: 'ex_30', name: 'Overhead Tricep Extension', type: 'gym', primaryMuscles: ['triceps'], secondaryMuscles: [], difficultyMultiplier: 0.4 },
